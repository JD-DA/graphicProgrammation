//
// Created by Jean-Daniel de Ambrogi on 25/02/2022.
//
#include <iostream>
#include <GL/glew.h>
#include <OpenGL//gl.h>
...
void init() {
    ...
    glBufferData(GL_ARRAY_BUFFER,36*sizeof(float),coordonnees,GL_STATIC_DRAW);
    glVertexAttribPointer(0,3,GL_FLOAT,GL_FALSE,0,(void*)0);
    glEnableVertexAttribArray(0);
    GLfloat couleurs[36*3];
